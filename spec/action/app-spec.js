...
describe('TransformPostcodeAction', function () {
    it('print and return', function () {
        ...
        expect(console.log).toHaveBeenCalledWith('result: ' + {error: ``, postCode:'45056-1234  cd is 0'});
    ...
    it('print and return', function () {
        ...
        spyOn(console, 'log');
        let result = changePostcode.doAction(cmd);
        expect(console.log).toHaveBeenCalledWith('result: ' + {error: `输入的条码不能有：和|以外的字符`, postCode: ``});
        expect(result).toEqual('条码转邮编');
    });
});
...
describe('TransformBarcodeAction', function () {
    it('print and return', function () {
        ...
        expect(console.log).toHaveBeenCalledWith('result: ' + {error: ``, barcode: `|:|::|:|:|:||::::|:|::||:::::||::|:|::||::|::|||:::|  cd is 0`});
    ...
    it('print and return', function () {
        ...
        spyOn(console, 'log');
        let result = changeBarcode.doAction(cmd);
        expect(console.log).toHaveBeenCalledWith('result: ' + {error: `输入的邮编位数必须是5或9`, barcode: ``});
        expect(result).toEqual('邮编转条码');
